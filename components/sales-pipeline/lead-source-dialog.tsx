...
import { LeadFinderDialog } from "./lead-finder-dialog"
...
export function LeadSourceDialog({ isOpen, onClose, onSelectUpload }: LeadSourceDialogProps) {
  ...
  if (showLeadFinder) {
    return <LeadFinderDialog isOpen={true} onClose={() => setShowLeadFinder(false)} />
  }
